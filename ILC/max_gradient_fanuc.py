...
def main():
    ...
    try:
        breakpoints,primitives,p_bp,q_bp=extract_data_from_cmd(os.getcwd()+'/'+data_dir+'command.csv')
    except:
        print("Convert breakpoints to command")
        ...
        df.to_csv(data_dir+'command.csv',header=True,index=False)
    ...
    for i in range(iteration):
        ...
        print('Iteration:',i,', Max Error:',max(error),', Ave. Speed:',ave_speed)
